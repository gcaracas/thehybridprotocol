...
export const metadata = {
  title: "Podcasts Dark || Resonance &mdash; One & Multi Page React Nextjs Creative Template",
  description: "Resonance &mdash; One & Multi Page React Nextjs Creative Template",
};
export default function PodcastsPageDark() {
  return (
    <>
                        ...
                        >
                          <div className="post-prev-container">
                            <div className="post-prev-img">
                              <Link href={`/podcasts-single/${elm.id}`}>
                                <Image
                                  src={elm.imgSrc}
                                  width={607}
                                  height={358}
