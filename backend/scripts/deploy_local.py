...
def create_media_directories():
    ...
    try:
        ...
        staticfiles_dir = os.environ.get('STATIC_ROOT', 'staticfiles')
...
def run_data_migrations():
    ...
    if not run_command('migrate', 'Running Django migrations'):
...
def main():
    ...
    print("🚀 Starting local deployment with data migrations...")
    print("=" * 60)
    ...
    print("   • Check the new models in Django admin")
