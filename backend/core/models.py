...
class PodcastEpisode(models.Model):
    ...
    duration = models.CharField(max_length=20, help_text="Duration in format: HH:MM:SS")
    ...
    apple_url = models.URLField(blank=True, null=True, help_text="Apple Podcasts URL")
    thumbnail = models.URLField(blank=True, null=True, help_text="Episode thumbnail URL")
    published = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    published_at = models.DateTimeField(blank=True, null=True)
